...
call_user_func(function () {
    $GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['nodeRegistry'][1500892324] = [
        ...
        'priority' => 40,
        'class' => \Supr\Supr\Form\Element\SuprWidgetElement::class,
    ];

    $GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['tcaDatabaseRecord'][\Supr\Supr\Form\FormDataProvider\SuprWidgets::class] = [
        'depends' => [
    ...
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['cms/layout/class.tx_cms_layout.php']['tt_content_drawItem']['supr_widget'] =
        \Supr\Supr\Hooks\SuprWidgetPreviewRenderer::class;
